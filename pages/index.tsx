      ...
      <div className="index">
        <div className="head w-screen h-screen">
          <div className="mt-[240px] w-full">
            ...
            <div className="text-black font-extrabold text-4xl text-center phone:text-3xl mt-4">Fast get ideas</div>
            <div className="text-black font-extrabold text-4xl text-center phone:text-3xl mt-4">Let's Brain Bomming</div>
          </div>
          <Link href="/list">
